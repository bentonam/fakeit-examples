...
[idx_routes_source_airport_codes.n1ql](indexes/idx_routes_source_airport_codes.n1ql)
...
[routes_originating_from_ICT.n1ql](queries/routes/routes_originating_from_ICT.n1ql)
...
[total_routes_originating_from_ICT.n1ql](queries/routes/total_routes_originating_from_ICT.n1ql)
...
[idx_routes_source_airport_codes_drop.n1ql](indexes/idx_routes_source_airport_codes_drop.n1ql)

```sql
DROP INDEX `flight-data`.idx_routes_source_airport_codes
```

[idx_routes_source_airport_codes_AtoM.n1ql](indexes/idx_routes_source_airport_codes_AtoM.n1ql)
...
[idx_routes_source_airport_codes_NtoZ.n1ql](indexes/idx_routes_source_airport_codes_NtoZ.n1ql)
...
[total_routes_originating_from_ATL_explain.n1ql](queries/routes/total_routes_originating_from_ATL_explain.n1ql)
...
[total_routes_originating_from_SFO_explain.n1ql](queries/routes/total_routes_originating_from_SFO_explain.n1ql)
...
[airlines_flying_from_airport.n1ql](queries/routes/airlines_flying_from_airport.n1ql)
...
[airlines_flying_from_airport_with_2plus_routes.n1ql](queries/routes/airlines_flying_from_airport_with_2plus_routes.n1ql)
...
[idx_routes_destination_airport_codes_AtoM.n1ql](indexes/idx_routes_destination_airport_codes_AtoM.n1ql)
...
[idx_routes_destination_airport_codes_NtoZ.n1ql](indexes/idx_routes_destination_airport_codes_NtoZ.n1ql)
...
[total_airlines_flying_to_destination.n1ql](queries/routes/total_airlines_flying_to_destination.n1ql)
...
[airlines_flying_to_destination_with_3plus_routes.n1ql](queries/routes/airlines_flying_to_destination_with_3plus_routes.n1ql)
...
[routes_within_300_miles_of_MCI.n1ql](queries/routes/routes_within_300_miles_of_MCI.n1ql)
...
[routes_within_300_kilometers_of_CDG.n1ql](queries/routes/routes_within_300_kilometers_of_CDG.n1ql)
